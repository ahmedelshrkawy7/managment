   ...
   <div className='dash__member-details'>
        ...
        <div className='member_details'>
            ...
            <div className='member_details-content'>
                <div className='member_details-content-name'>
                    ...
                    <div className='flex w-full justify-center gap-4 employee_edit'>
                        <img src={pen} alt='person' onClick={()=>{navigate(`/createemployee`,{state:employee})}}/>
                        <img src={trash} alt='person' onClick={()=>{handleDelete(employee.id)}}/>
            ...
            <div className='member_details-btn'>
                <button type='button' onClick={()=>{navigate(`/member_Alldetails/${employee.id}`,{state : employee})}}>View Details</button>
            </div>
