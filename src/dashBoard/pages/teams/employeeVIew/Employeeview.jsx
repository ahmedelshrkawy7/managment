...
const Employeeview = () => {
  ...
  const items = [
    { name: "First Name", data: project?.first_name },
    { name: "Last Name", data: project?.last_name },
    { name: " Position ", data: project?.position },
    { name: "Department ", data: project?.departments[0]?.title || "" },
    { name: "Specialization", data: project?.subdepartments[0]?.title },
    { name: "Technologies", data: [...string] },
    { name: "Experience", data: project?.experience || "" },
    { name: "Governorate", data: project?.governorate.governorate },
    { name: "Adress", data: project?.address },
    { name: "Gender", data: project?.gender?.gender },
  ];
  const personal = [
    {
      name: "Work Hours",
      data: project?.workhours,
    } /*{name:'Work Type',data: project?.type},*/,
    { name: " Salary ", data: project?.salary },
    { name: "Phone Number ", data: project?.mobile[0] },
  ...
  return (
    <>
      <Location
        main="Team List"
        head={`${project?.first_name}${project?.last_name}`}
      />
